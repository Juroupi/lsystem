...
tree: lsystem # card = 13 * n - (n - 1)
	./lsystem file=tests/tree.bnf start=T angle=30 card=601 y=350 a=-90 method=uniform
...
curve: lsystem # card = 5 * n - (n - 1)
	./lsystem file=tests/curve.bnf start=A angle=60 card=53 method=nuniform
...
spath: lsystem # card = 11 * n - (n - 1)
	./lsystem file=tests/spath.bnf start=P angle=90 card=101 growth=3 x=0 d=400 method=nuniform
